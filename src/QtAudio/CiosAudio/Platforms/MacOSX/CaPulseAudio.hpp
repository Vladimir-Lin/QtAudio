...
#ifndef CAPULSEAUDIO_HPP
#define CAPULSEAUDIO_HPP
...
class PulseAudioStream : public Stream
{
  public:
    ...
    explicit        PulseAudioStream (void) ;
    virtual        ~PulseAudioStream (void) ;
...
class PulseAudioDeviceInfo : public DeviceInfo
{
  public:

    explicit PulseAudioDeviceInfo (void) ;
    virtual ~PulseAudioDeviceInfo (void) ;
...
class PulseAudioHostApiInfo : public HostApiInfo
{
public:

    explicit PulseAudioHostApiInfo (void) ;
    virtual ~PulseAudioHostApiInfo (void) ;
...
class PulseAudioHostApi : public HostApi
{
  public:
    ...
    explicit  PulseAudioHostApi  (void) ;
    virtual  ~PulseAudioHostApi  (void) ;
