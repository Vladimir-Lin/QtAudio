...
#ifndef CASKELETON_HPP
#define CASKELETON_HPP

#include "CiosAudioPrivate.hpp"

/******************************************************************************
 *                                                                            *
 * Author Foxman's(lin.foxman@gmail.com) Note:                                *
 *                                                                            *
 * Skeleton Host API is meant to be an example for your Host API development. *
 *                                                                            *
 * Skeleton provides a starting point for implementing support for a new host *
 * CIOS Audio Core.  The idea is that you copy the whole thing to a new       *
 * directory inside Skeleton directory and start editing.                     *
 *                                                                            *
 ******************************************************************************/
...
class SkeletonStream : public Stream
{
  public:
    ...
    explicit        SkeletonStream  (void) ;
    virtual        ~SkeletonStream  (void) ;
...
class SkeletonDeviceInfo : public DeviceInfo
{
  public:

    explicit SkeletonDeviceInfo (void) ;
    virtual ~SkeletonDeviceInfo (void) ;
...
class SkeletonHostApiInfo : public HostApiInfo
{
public:

    explicit SkeletonHostApiInfo (void) ;
    virtual ~SkeletonHostApiInfo (void) ;
...
class SkeletonHostApi : public HostApi
{
  public:
    ...
    explicit  SkeletonHostApi    (void) ;
    virtual  ~SkeletonHostApi    (void) ;
